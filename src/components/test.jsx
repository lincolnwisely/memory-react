...
class ImageContainer extends React.Component {
  ...
  addActiveImage(obj) {
    ...
    this.setState({activeImages: obj});
      ...
      <div style={flexStyle}>
        {this.props.images.map((img, i) => (
          ...
          <Image
            ...
            // imgStyle={this.state.activeImages.includes(i) ? imgActive : imgInactive }
      ...
      <div style={flexStyle}>
        {this.props.images.map((img, i) => (
          ...
          <Image
            ...
            addActiveImage={this.addActiveImage}
            compare={this.compareActiveImages}
            imgStyle={this.state.activeImages.find(i) ? imgActive : imgInactive }
            // creditStyle={this.state.activeImages.includes({i: img.id}) ? creditActive : creditInactive}
          />
          </div>
        ))}
